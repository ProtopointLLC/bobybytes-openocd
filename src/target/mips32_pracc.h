...
/* Progress reporting for PRACC writes, which run at a few KiB/s. */
#define MIPS32_PRACC_PROGRESS_MIN_BYTES		(64 * 1024)
#define MIPS32_PRACC_PROGRESS_INTERVAL_MS	2000
